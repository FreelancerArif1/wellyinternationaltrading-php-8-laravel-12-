...
class ResourceController extends Controller
{
    ...
    public function getList(Request $request){
        ...
        ->editColumn('image', function ($row) {
            return ($row->image) ? '<a href="'.asset('uploads/resource-images/'.$row->image).'" target="_blank"><img class="profile-img b-1" src="'.asset('uploads/resource-images/'.$row->image).'" alt="profile image"></a>' : '<img class="profile-img b-1" src="'.asset('Backend/images/no-img.jpg').'" alt="profile image">';
        })
