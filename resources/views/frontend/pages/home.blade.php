    ...
    <main>
        ...
        <div class="swiper">
              ...
              <div class="slider-card overlay">
                <picture class="slider-media">
                  <source
                    ...
                    srcset="frontend/assets/img/slider/hero-575.jpg"
                  >
                  <source
                    media="(max-width: 991px)"
                    srcset="frontend/assets/img/slider/hero-991.jpg"
                  >
                  <img
                    src="frontend/assets/img/slider/hero-1.jpg"
                    width="1920"
                    height="1000"
                    loading="eager"
                    alt="Hero Image"
                  ...
                  <div class="container height-100 d-flex align-items-center">
                    <div class="content-box slider-animation section-headings">
                      ...
                      <div class="text text-18">
                        ...
                        our team of seasoned consultants unparalleled. Transform
                        your business.
                      </div>
                      <div class="buttons">
                        <a
            ...
            <div class="swiper-slide">
              <div class="slider-card overlay">
                <picture class="slider-media">
                  <source
                    media="(max-width: 575px)"
                    srcset="frontend/assets/img/slider/hero2-575.jpg"
                  >
                  <source
                    media="(max-width: 991px)"
                    srcset="frontend/assets/img/slider/hero2-991.jpg"
                  >
                  <img
                    src="frontend/assets/img/slider/hero-2.jpg"
                    width="1920"
                    height="1000"
                    loading="lazy"
                    alt="Hero Image"
          ...
          <div class="slider-nav">
            <div class="swiper-button-prev">
              ...
              >
                <path
                  d="M14.6663 25.3359L5.33301 16.0026M5.33301 16.0026L14.6663 6.66927M5.33301 16.0026H26.6663"
                  stroke="CurrentColor"
                  stroke-width="2"
            ...
            <div class="swiper-button-next">
              ...
              >
                <path
                  d="M17.3337 25.3359L26.667 16.0026M26.667 16.0026L17.3337 6.66927M26.667 16.0026H5.33366"
                  stroke="CurrentColor"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-12">
              <div class="media-wrap" data-aos="zoom-in-up">
                <img
                  src="frontend/assets/img/image-text/img1.png"
                  width="992"
                  height="863"
                  loading="lazy"
                  alt="Image"
            ...
            <div class="content-lists running-animation">
              <div class="content-item">
                <a href="about.html" class="content-link">
                  <img
                    src="frontend/assets/img/brand/b1.png"
                    width="108"
                    height="36"
                    loading="lazy"
                    alt="Brand Image"
                ...
                <a href="about.html" class="content-link">
                  <img
                    src="frontend/assets/img/brand/b2.png"
                    width="108"
                    height="36"
                    loading="lazy"
                    alt="Brand Image"
                ...
                <a href="about.html" class="content-link">
                  <img
                    src="frontend/assets/img/brand/b3.png"
                    width="108"
                    height="36"
                    loading="lazy"
                    alt="Brand Image"
                ...
                <a href="about.html" class="content-link">
                  <img
                    src="frontend/assets/img/brand/b4.png"
                    width="108"
                    height="36"
                    loading="lazy"
                    alt="Brand Image"
                ...
                <a href="about.html" class="content-link">
                  <img
                    src="frontend/assets/img/brand/b5.png"
                    width="108"
                    height="36"
                    loading="lazy"
                    alt="Brand Image"
      ...
      <div class="multicolumn mt-100 section-padding">
        <div class="media media-bg">
          <img
            src="frontend/assets/img/contact/contact-bg.jpg"
            width="1920"
            height="883"
            loading="lazy"
        ...
        <div class="container">
          ...
          <div class="multicolumn-inner">
            <div class="row">
              ...
              <div
                class="col-lg-4 col-12 multi-col"
                data-aos="fade-up"
                data-aos-delay="200"
              >
                <a
      ...
      <div class="recent-project mt-100">
        <div class="container">
              ...
              <div class="col-lg-8 col-12">
                <div class="project-img-large">
                  <div class="project-img radius18" data-aos="zoom-in-up">
                    <img
                      src="frontend/assets/img/project/1.jpg"
                      width="1000"
                      height="595"
                      loading="lazy"
                      alt="Image"
                  ...
                  <a
                    href="project.html"
                    class="project-media-button button button--primary"
                    data-aos="zoom-in-up"
                  ...
                  >
                    ...
                    >
                      <path
                        d="M15.1663 22.1641L23.333 13.9974M23.333 13.9974L15.1663 5.83073M23.333 13.9974H4.66634"
                        stroke="CurrentColor"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                ...
                <div class="row project-img-small">
                  <div class="col-6">
                    <div class="project-img radius18" data-aos="fade-left">
                      <img
                        src="frontend/assets/img/project/2.jpg"
                        width="500"
                        height="385"
                        loading="lazy"
                        alt="Image"
                  ...
                  <div class="col-6">
                    <div
                      class="project-img radius18"
                      data-aos="fade-left"
                      data-aos-delay="200"
                    >
                      <img
                        src="frontend/assets/img/project/3.jpg"
                        width="500"
                        height="385"
                        loading="lazy"
                        alt="Image"
          ...
          <div
            class="project-content radius18 section-headings"
            data-aos="fade-up"
          >
            <h2 class="heading text-36" data-aos="fade-up" data-aos-delay="50">
              Unlocking New Opportunities for Sustainable Growth
            </h2>
            <div class="text text-18" data-aos="fade-up" data-aos-delay="100">
              The solar solution company specializes in providing innovative,
              eco-friendly energy systems harness the power.
            </div>
            <div
              class="project-button buttons"
              data-aos="fade-up"
              data-aos-delay="150"
            >
              <a
            ...
            <div class="row">
              ...
              <div class="col-lg-5 col-12">
                <div class="promotion-img radius18" data-aos="flip-left">
                  <img
                    src="frontend/assets/img/promotion/1.jpg"
                    width="1000"
                    height="1469"
                    loading="lazy"
                    alt="Promotion image"
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/1.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/2.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/3.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/4.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/5.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/6.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
                ...
                <div class="swiper-slide">
                  <div class="card-team radius18">
                    <img
                      src="frontend/assets/img/team/7.jpg"
                      alt="team image"
                      width="500"
                      height="619"
                      loading="lazy"
              ...
              <div class="testimonial-card-inner">
                ...
                >
                  ...
                  <p class="text text-24">
                    ...
                    reviews that I have already are company and the reviews that
                    I have already are all excellent. Not only the design but
                    the are company and the reviews code ”
                  </p>
            ...
            <div class="row product-grid">
              <div class="col-12 col-xl-6">
                <div class="card-blog-list" data-aos="fade-up">
                  <div class="card-blog-list-media radius18">
                    <div class="media">
                      <img
                        src="frontend/assets/img/blog/9.jpg"
                        alt="blog image"
                        width="1000"
                        height="707"
                        loading="lazy"
                  ...
                  <h2 class="card-blog-heading heading text-32">
                    <a href="blog-details.html" class="heading text-32">
              ...
              <div class="col-12 col-xl-6">
                <div class="horizontal-blogs">
                  <div
                    class="card-blog-list-horizontal radius18"
                    data-aos="fade-up"
                  >
                    <div class="card-blog-list-media">
                      <div class="media">
                        <img
                          src="frontend/assets/img/blog/2.jpg"
                          alt="blog image"
                          width="1000"
                          height="707"
                          loading="lazy"
                    ...
                    <div class="card-blog-content">
                      ...
                      <h2 class="card-blog-heading heading text-24">
                        <a href="blog-details.html" class="heading text-24">
                      ...
                      <div class="buttons">
                        ...
                        >
                          ...
                          <span class="visually-hidden"
                            >To see blog details, click here</span
                          >
                        </a>
                      </div>
                    </div>
                  ...
                  >
                    <div class="card-blog-list-media">
                      <div class="media">
                        <img
                          src="frontend/assets/img/blog/1.jpg"
                          alt="blog image"
                          width="1000"
                          height="707"
                          loading="lazy"
                  ...
                  >
                    <div class="card-blog-list-media">
                      <div class="media">
                        <img
                          src="frontend/assets/img/blog/3.jpg"
                          alt="blog image"
                          width="1000"
                          height="707"
                          loading="lazy"
