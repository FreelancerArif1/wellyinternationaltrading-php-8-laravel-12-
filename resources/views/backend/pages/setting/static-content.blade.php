...
@section('title', 'Settings | '.Helper::getSettings('application_name') ?? 'Livenza Group' )
@section('content')
            ...
            <div class="card-body pb-0">
                <form action="{{ route('admin.setting.update') }}" id="settingForm" method="post" enctype="multipart/form-data">
                    ...
                    {{-- <div class="form-goup row">
                        ...
                        <div class="col-sm-3">
                            <input type="file" class="form-control" onchange="previewFile('settingForm #mission_vision_image', 'settingForm .mission_vision_image')" name="mission_vision_image" id="mission_vision_image">
                            <img src="{{ Helper::getSettings('mission_vision_image') ? asset(Helper::getSettings('mission_vision_image')) : asset('assets/img/no-img.jpg')}}" height="80px" width="100px" class="mission_vision_image mt-1 border" alt="">
                        </div>
                    </div> --}}
