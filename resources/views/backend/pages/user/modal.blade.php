        ...
        <div class="modal-content">
            <form id="createUserForm" action="{{ route('admin.user.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group  row">
                        <label for="" class="col-sm-2 col-form-label">Image<span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10">
                            <input class="form-control" type="file" onchange="previewFile(this, 'previewImg')"
                                name="profile_image" id="profile_image" required>
                            <img id="previewImg" src="{{ asset('backend/images/no-img.jpg') }}" height="80px"
                                width="100px" class="preview_image mt-1 border" alt="">
...
<div class="modal fade" id="changePrivilegePasswordModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="changePrivilegeForm" action="{{ route('admin.privilege.user.password') }}" method="post">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Privilege User Password </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa-solid fa-xmark"></i></span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="user_id" id="privilege_user_id" value="">
                    <a type="button" class="modal__btn_space" data-bs-dismiss="modal">Close</a>
                    <button type="submit" id="changePrivilegePasswordBtn" class="btn btn-primary"
                        data-check-area="modal-body">Change Password</button>
                </div>
            </form>
        </div>
