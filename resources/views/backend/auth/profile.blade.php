                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3 text-center">
                                <img class="border-redius-50 preview_img" src="{{ (Auth::user()->profile_image) && (File::exists(public_path('uploads/user-images/' . Auth::user()->profile_image))) ? asset('uploads/user-images/' . Auth::user()->profile_image) : asset('uploads/user-images/user-demo.jpg') }}" alt="profile image" height="80px" width="80px">
                            </div>
